...
import pe.edu.vallegrande.teacher.application.client.AuthServiceClient;
...
public class TeacherServiceImpl implements ITeacherService {
    ...
    @Override
    public Mono<String> getTeacherIdByUid(String uid) {
        return teacherRepository.findByUid(uid)
                .map(Teacher::getId) // Extraemos el ID del estudiante
                .switchIfEmpty(Mono.error(new Exception("Student not found for UID: " + uid)));
    }
